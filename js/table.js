...
function createTable(usersList) {
    for (let i = 0; i < usersList.length ; i++) {
        ...
        //    Si ( en los elementos terminan en "@academlo.com") >>>> de esta forma esta iterando cada uno de los ELementos del arreglo
            ...
            let usersAge = document.createElement("td");
            // creamos un elemento en "td"
            usersAge.innerText = usersList[i].age;
            // incorporamos texto para este nuevo elemento
            ...
            for (let index =0; index < usersList[i].social-length; index++){
                ...
                let usersSocial = usersList[i].social {  
                if(let usersSocial = document.createElement("td");
                // creamos un elemento en "td"
                usersSocial.innerText = usersList[i].social[index].url);
                // incorporamos texto para este nuevo elemento)
                
                let usersSocial = document.createElement("td");
                // creamos un elemento en "td"
                usersSocial.innerText = usersList[i].social;
                // incorporamos texto para este nuevo elemento
            ...
            newRow.appendChild(usersAge);
            // Cree el listado de Age
            newRow.appendChild(usersGender);
            // Cree el listado de Gender
            newRow.appendChild(usersSocial);
            // Cree el listado de Social
